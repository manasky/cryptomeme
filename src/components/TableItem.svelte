...
<tr class="hover">
  ...
  <td>
    <div class="flex items-center gap-1">
      <svg class="w-5 h-5 fill-current text-success" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M17.92,6.62a1,1,0,0,0-.54-.54A1,1,0,0,0,17,6H7A1,1,0,0,0,7,8h7.59l-8.3,8.29a1,1,0,0,0,0,1.42,1,1,0,0,0,1.42,0L16,9.41V17a1,1,0,0,0,2,0V7A1,1,0,0,0,17.92,6.62Z"/></svg>
      <span class="font-mono text-lg">${coin.current_price.toLocaleString()}</span>
    </div>
  </td>
  <td>
    <div class="flex items-center gap-1">
      ...
      <span class="font-mono text-sm">{Number(Math.abs(coin.price_change_percentage_24h)).toFixed(2)}%</span>
    </div>
  </td>
  <td>
    <div class="flex items-center gap-1">
      ...
      <span class="font-mono text-sm">{Number(Math.abs(coin.price_change_percentage_7d)).toFixed(2)}%</span>
    </div>
  </td>
