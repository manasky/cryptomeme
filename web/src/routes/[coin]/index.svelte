  ...
  <div class="flex gap-12 flex-col-reverse items-center md:flex-row">
    <div class="w-full md:w-80 rounded-box flex flex-col gap-4">
      ...
      <div class="px-4"> 
        ...
        <div class="relative pt-8">
          <div class="tooltip absolute tooltip-open tooltip-primary" data-tip="${formatPrice(coin.current_price)}" style="left:{100 - Number(Math.abs(coin.ath_change_percentage))}%">
            <div class="w-px"></div>
          </div>
        </div>
        <div class="h-2 p-px flex items-stretch bg-base-content bg-opacity-20 rounded-full">
